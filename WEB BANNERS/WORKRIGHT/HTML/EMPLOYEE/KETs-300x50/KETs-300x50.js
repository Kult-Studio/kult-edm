...
lib.ssMetadata = [
		{name:"KETs_300x50_atlas_1", frames: [[0,610,603,57],[0,525,615,83],[0,0,667,104],[0,424,547,99],[0,106,625,104],[0,212,625,104],[0,318,625,104]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:1.25,alpha:1},9).wait(41).to({startPosition:0},0).to({y:50.9,alpha:0},9).to({_off:true},1).wait(205));

	// BG_in
	this.instance_2 = new lib.Tween26("synched",0);
	this.instance_2.setTransform(150.5,-53.5,0.935,1,0,0,0,24.2,-104.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:5.45},9).to({_off:true},126).wait(130));
	...
	this.instance_4.setTransform(150,24.95,1,1.0028,0,0,0,0.1,-100);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/KETs_300x50_atlas_1.png?1693473173086", id:"KETs_300x50_atlas_1"}
	],
	preloads: []
};
