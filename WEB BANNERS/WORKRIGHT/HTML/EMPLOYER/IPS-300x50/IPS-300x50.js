...
lib.ssMetadata = [
		{name:"IPS_300x50_atlas_1", frames: [[0,424,615,83],[0,0,667,104],[524,509,262,57],[0,509,522,91],[524,568,40,31],[0,602,604,76],[0,106,625,104],[0,212,625,104],[0,318,625,104],[617,424,280,51]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(55).to({_off:false},0).to({y:24.95,alpha:1},10).wait(60).to({y:25.1},0).to({y:-18.2,alpha:0},9).to({_off:true},1).wait(200));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:27.95,alpha:1},9).wait(41).to({startPosition:0},0).to({y:74.8,alpha:0},9).to({_off:true},1).wait(275));

	// Toolkit_Text
	this.instance_2 = new lib.ttext("synched",0);
	this.instance_2.setTransform(217.1,-26);
	...
	this.instance_3.setTransform(144,4.1,0.0263,0.0339,0,0,0,-3.8,-3);
	...
	this.instance_4.setTransform(78.7,24.2,0.004,0.0182,0,0,0,-25.3,-5.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(138).to({_off:false},0).to({regX:-31.8,regY:-6.7,scaleX:1,scaleY:1,x:78.65,alpha:1},6).to({_off:true},61).wait(130));

	// BG_in
	this.instance_5 = new lib.Tween26("synched",0);
	this.instance_5.setTransform(150.4,-33.5,0.935,1,0,0,0,24.1,-84.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:25.05},9).to({_off:true},196).wait(130));

	// BG
	this.instance_6 = new lib.ips_bgOUT();
	this.instance_6.setTransform(0,0,0.4505,0.4808);

	this.instance_7 = new lib.bgtagline("synched",0);
	this.instance_7.setTransform(149.9,24.95,1,1.0028,0,0,0,0.1,-100);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(205).to({_off:false},0).to({x:150,alpha:1},12).to({_off:true},48).wait(70));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IPS_300x50_atlas_1.png?1693472573350", id:"IPS_300x50_atlas_1"}
	],
	preloads: []
};
