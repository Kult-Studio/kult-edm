...
lib.ssMetadata = [
		{name:"IPS_320x50_atlas_1", frames: [[0,424,615,83],[0,0,667,104],[524,509,262,57],[0,509,522,91],[524,568,40,31],[0,602,573,76],[0,106,667,104],[0,212,667,104],[0,318,667,104],[617,424,280,51]]}
];
...
(lib.ips_bgIN = function() {
	this.initialize(ss["IPS_320x50_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(-74.8,-35.2,276.7,36.2);
...
// stage content:
(lib.IPS320x50 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(161.8,79.8,1,1,0,0,0,63.5,-17.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(55).to({_off:false},0).to({y:25.1,alpha:1},10).wait(60).to({startPosition:0},0).to({y:-29.2,alpha:0},9).to({_off:true},1).wait(200));

	// KETs_Header
	this.instance_1 = new lib.Tween22("synched",0);
	this.instance_1.setTransform(166.45,-28.2,1,1,0,0,0,-2.6,-27.2);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:27.7,alpha:1},9).wait(41).to({startPosition:0},0).to({y:80.8,alpha:0},9).to({_off:true},1).wait(275));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(138).to({_off:false},0).to({regX:-31.8,regY:-6.7,scaleX:1,scaleY:1,x:87.15,y:23.95,alpha:1},6).to({_off:true},61).wait(130));
...
p.nominalBounds = new cjs.Rectangle(159.5,-67.4,161,168.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IPS_320x50_atlas_1.png?1693463265512", id:"IPS_320x50_atlas_1"}
	],
	preloads: []
};
