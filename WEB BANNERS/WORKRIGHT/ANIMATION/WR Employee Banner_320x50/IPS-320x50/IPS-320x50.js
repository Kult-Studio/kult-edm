...
lib.ssMetadata = [
		{name:"IPS_320x50_atlas_1", frames: [[0,424,615,83],[0,0,667,104],[0,509,522,91],[0,602,573,76],[0,106,667,104],[0,212,667,104],[0,318,667,104]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(55).to({_off:false},0).to({y:25.1,alpha:1},10).to({_off:true},70).wait(130));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:27.7,alpha:1},9).wait(41).to({startPosition:0},0).to({y:80.8,alpha:0},9).to({_off:true},1).wait(205));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/IPS_320x50_atlas_1.png?1693902297247", id:"IPS_320x50_atlas_1"}
	],
	preloads: []
};
