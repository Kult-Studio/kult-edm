...
lib.ssMetadata = [
		{name:"KETs_300x50_atlas_1", frames: [[0,610,603,57],[0,525,615,83],[0,0,667,104],[549,424,262,57],[0,424,547,99],[669,0,40,31],[0,106,625,104],[0,212,625,104],[0,318,625,104],[627,106,280,51]]}
];
...
(lib.ips_sub = function() {
	this.initialize(ss["KETs_300x50_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(-74.8,-35.2,291.1,27.1);
...
// stage content:
(lib.KETs300x50 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(55).to({_off:false},0).to({y:11.6,alpha:1},10).wait(60).to({startPosition:0},0).to({y:-35.2,alpha:0},9).to({_off:true},1).wait(200));

	// KETs_Header
	this.instance_1 = new lib.Tween22("synched",0);
	this.instance_1.setTransform(281.4,-54.1,1,1,0,0,0,129.1,-51.1);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:1.25,alpha:1},9).wait(41).to({startPosition:0},0).to({y:50.9,alpha:0},9).to({_off:true},1).wait(275));

	// Toolkit_Text
	this.instance_2 = new lib.ttext("synched",0);
	this.instance_2.setTransform(216.1,-26);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(128).to({_off:false},0).to({y:23.3},10).to({_off:true},67).wait(130));

	// Spark
	this.instance_3 = new lib.spark("synched",0);
	this.instance_3.setTransform(142.8,4.1,0.0263,0.0339,0,0,0,-3.8,-3);
	...
	this.instance_4.setTransform(77.45,23.95,0.004,0.0182,0,0,0,-25.3,-5.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(138).to({_off:false},0).to({regX:-31.8,regY:-6.7,scaleX:1,scaleY:1,x:77.4,alpha:1},6).to({_off:true},61).wait(130));

	// BG_in
	this.instance_5 = new lib.Tween26("synched",0);
	this.instance_5.setTransform(150.5,-53.5,0.935,1,0,0,0,24.2,-104.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:5.45},9).to({_off:true},196).wait(130));

	// BG
	this.instance_6 = new lib.kets_bgOUT();
	this.instance_6.setTransform(0,0,0.4505,0.4808);

	this.instance_7 = new lib.bgtagline("synched",0);
	this.instance_7.setTransform(150,24.95,1,1.0028,0,0,0,0.1,-100);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.logos("synched",0,false);
	this.instance_8.setTransform(150.35,25.3,1.0014,1.0002,0,0,0,0.3,-99.7);

	this.instance_9 = new lib.logos2("synched",0);
	this.instance_9.setTransform(150,25.25,0.4805,0.4812,0,0,0,-20.9,0.1);
...
p.nominalBounds = new cjs.Rectangle(149.8,-29.1,150.7,128);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/KETs_300x50_atlas_1.png?1693472501978", id:"KETs_300x50_atlas_1"}
	],
	preloads: []
};
